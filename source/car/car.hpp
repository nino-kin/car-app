...
/// @note ACC: very limited power--pretty much just the radio, MFD, Bluetooth.
/// One push of the Power button without your foot on the brake.
/// @note POWER_ON: gives you power to the fans, windows, and most other stuff.
/// 2 pushes of the Power button without your foot on the brake.
/// @note READY: closes the circuits to the HV battery and fires up all the ECUs
/// to make the car drivable. Any single press of the Power button while your
/// foot is on the brake from either ACC, POWER ON, or when the car is totally
/// off.
enum class PowerState { OFF = 0, ACC, ON, READY };
...
class Car {
 public:
  /// @brief Constructor
  /// @note Initialize with power off, speed 0, driving mode STOP, and fully
  /// charged battery
