...
ShiftPosition Shift::getPosition() const { return position_; }

std::string Shift::getShiftString() const { return shiftMap[position_]; }

bool Shift::getFaultStatus() const { return is_fault_; }
